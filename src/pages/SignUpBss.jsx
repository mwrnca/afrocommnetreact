...
export default function SignUpBss() {
  ...
  return (
    <>
      ...
      <section className="roles">
        <h3 style={{ color: 'rgb(243, 238, 238)' }}>you have selected bussiness operator as the nature of your account if this is the intended nature of your account you may proceed if not click on the button bellow to direct you back to the home page</h3>
