    ...
    <>
      ...
      <section className="container">
        <div className="input">
          ...
          <input id="instName" type="text" placeholder="Name of Institution" required />
          <input id="nature" type="text" placeholder="Nature of Institution" required />
          <input id="location" type="text" placeholder="Location of Institution" required />
          ...
          <a className="btn-cont" onClick={() => navigate('/dash.inst')}>Sign Up</a>
        </div>
      </section>

      <section className="roles">
        <h3 style={{ color: 'rgb(247, 245, 245)' }}>you have selected institution as the nature of your account if this is the intended nature of your account you may proceed if not click on the button bellow to direct you back to the home page</h3>
