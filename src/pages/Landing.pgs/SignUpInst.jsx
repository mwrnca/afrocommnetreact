  ...
  return (
    <section className="page-container">
      ...
      <section className="signup-container">
          ...
          <div onClick={() => navigate('/dash/inst')} className="btn-green" style={{ margin: '20px', width: '80%' }}>
            <span>FINISH</span>
          </div>
      ...
      <section className="roles">
        <h3 style={{ color: 'rgb(243, 238, 238)' }}>you have selected Institution as the nature of your account if this is the intended nature of your account you may proceed if not click on the button bellow to direct you back to the home page</h3>
