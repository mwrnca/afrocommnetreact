...
export default function RevenueContainer() {
  ...
  useEffect(() => {
    fetch("http://localhost:3001/revenue")
      ...
      .then(all => {
        ...
        // growth between first and last entry
  ...
  // profit/loss is positive or negative
  ...
  return (
    <div className="container">
      ...
      <div className="card-sales">
        ...
        {/* area chart looks best for revenue */}
        <ResponsiveContainer width="100%" height={220}>
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            <defs>
              {/* gradient fill under the revenue line */}
      ...
      <div className="card completed">
        <h3>Total Profit</h3>
        <h2>{totals.profit.toLocaleString("en-KE")}</h2>
      </div>
