...
export default function DashHome({ rolePrefix }) {
  // rolePrefix e.g. "bss", "inst", "prof" — used to build correct nav links
  ...
  return (
    <div className="dash-home-summary">
      ...
      <div className="dash-stat-row">
        ...
        <div
          className="dash-stat-card dash-stat-clickable"
          onClick={() => navigate(`/dash/${rolePrefix}/communities`)}
        >
      ...
      {completeness < 100 && (
        <div className="dash-completeness-card">
          ...
          {missing.length > 0 && (
            <p className="dash-completeness-missing">
      ...
      {/* two-column: recent messages + tasks due */}
      <div className="dash-two-col">
        <div className="dash-mini-section">
          ...
          {recentMsgs.length === 0 ? (
            ...
            recentMsgs.map(m => (
              <div key={m.id} className="dash-mini-item" onClick={() => navigate(`/dash/${rolePrefix}/inbox`)}>
        ...
        <div className="dash-mini-section">
          ...
          {tasksDue.length === 0 ? (
            ...
            tasksDue.map(t => (
              <div key={t.id} className="dash-mini-item" onClick={() => navigate(`/dash/${rolePrefix}/todo`)}>
