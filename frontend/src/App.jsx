...
import AssignedTasks from './pages/Dash.pgs/AssignedTasks'
import NoticeBoard from './pages/Dash.pgs/NoticeBoard'
  ...
  return (
    <section className='app-container'>
      <Routes>
        ...
        {/* ── Employee dashboard ── */}
        <Route path="/dash/employee" element={<Layout />}>
        ...
        <Route path="/dash/empl-mgmt" element={<Layout />}>
          <Route index element={<DashEmplMgmt />} />
        </Route>
