...
export default function SignUpBss() {
  ...
  const [step,   setStep]   = useState(1); // step 1 = base info, step 2 = business info
  ...
  return (
    <section className="page-container">
      ...
      <section className="roles">
        ...
        <p>Register your business to access sales tracking, employee management, communities and more.</p>
      </section>
      ...
      <section className="signup-container">
        ...
        {step === 1 ? (
          ...
          <>
            ...
            <input name="nature_of_business"   type="text" placeholder="Nature of Business e.g. Restaurant, Tech" value={profile.nature_of_business} onChange={handleProfile} />
            ...
            <textarea name="description" placeholder="Short description of your business (visible to consumers)" value={profile.description} onChange={handleProfile} />
            {error && <p className="msg-error">{error}</p>}
